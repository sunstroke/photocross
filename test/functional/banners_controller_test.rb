...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { bg: @banner.bg, info: @banner.info, pos: @banner.pos, position: @banner.position }
    end
  ...
  test "should update banner" do
    put :update, id: @banner, banner: { bg: @banner.bg, info: @banner.info, pos: @banner.pos, position: @banner.position }
    assert_redirected_to banner_path(assigns(:banner))
  end
